    ...
    script: [
      {
        ...
        innerHTML: `__GetI=typeof __GetI=='undefined'?[]:__GetI(function(){__GetI.push({type:"VIEW",site_id:"7414",product_id:"",product_price:"",category_id:"",pixel_id:""});var t="undefined"==typeof __GetI_domain?"px.adhigh.net":__GetI_domain,e=("https:"==document.location.protocol?"https://":"http://")+t+"/p.js",p=document.createElement("script");p.type="text/javascript",p.src=e;var _=document.getElementsByTagName("script")[0];_.parentNode.insertBefore(p,_)})();`,
