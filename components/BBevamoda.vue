<template>
  <section class="evamoda">
    <div class="evamoda-wrapper--img">
      <img
        src="~/assets/images/evamoda.png"
        alt="КОСМЕТИКА ДЕТСКАЯ, НАБОРЫ ДЛЯ СОЗДАНИЯ УКРАШЕНИЙ, СУМОЧКИ И АКСЕССУАРЫ"
        class="evamoda-img"
      >
      <div class="evamoda-wrapper--wrapper">
        <p class="evamoda-text">
          красота<br>спасёт мир!
        </p>
        <p class="evamoda-text evamoda-text--small">
    ...
    <div class="evamoda-wrapper--items">
      <div class="evamoda-item evamoda-item--evamoda">
        eva moda косметика детская
      </div>
      <div class="evamoda-item evamoda-item--bodyart">
        боди-арт, переводные татуировки,<br>дизайн ногтей
      </div>
      <div class="evamoda-item evamoda-item--accesoires">
        наборы для создания украшений и аксессуаров
      </div>
      <div class="evamoda-item evamoda-item--umbrella">
        десткие зонтики и сумочки
      </div>
      <div class="evamoda-item evamoda-item--bags">
...
.evamoda {
  ...
  &-wrapper {
    &--img {
      margin: 115px 0 0 calc(1920px/2 - 1021px/2 - 330px);
      display: flex;
      justify-content: center;
      align-items: center;
      @media (max-width: 1920px) {
        margin: 110px 0 0 calc(50vw - 1021px/2 - 430px);
      }
      @media (max-width: 1600px) {
        margin: 110px 0 0 calc(50vw - 1021px/2 - 270px);
      }
      @media (max-width: 1440px) {
        margin: 110px 0 0 calc(50vw - 1021px/2 - 190px);
      }
      @media (max-width: 1280px) {
        margin: 110px 0 0 calc(50vw - 1021px/2 - 110px);
      }
  ...
  &-item {
    ...
    &--bodyart {
      background-color: #b06ec8;
    }
    &--accesoires {
      background-color: #f9aad3;
    }
    &--umbrella {
