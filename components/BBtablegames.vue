<template>
  <section class="tablegames">
    <div class="tablegames-wrapper--img">
      <img
        src="~/assets/images/tablegames.png"
        alt="Делу время, потехе - чаc"
        class="tablegames-img"
      >
      <div class="tablegames-wrapper--wrapper">
        <p class="tablegames-text">
          делу время,<br>потехе - чаc
        </p>
        <div class="tablegames-button--wrapper">
          <button
          ...
          <!--          <button class="tablegames-button tablegames-button&#45;&#45;up" @click="$emit('goToNextPage', 'BBevamoda')">-->
    ...
    <div class="tablegames-wrapper--items">
      <div class="tablegames-item tablegames-item--antistress">
        игрушки-антистресс<span class="tablegames-item--small">сквиши, тянучки, пружинки, мякиши и лизуны</span>
      </div>
      <div class="tablegames-item tablegames-item--transport">
        транспорт<span class="tablegames-item--small">машинки, треки, железные дороги</span>
      </div>
      <div class="tablegames-item tablegames-item--rolegames">
        сюжетно-ролевые игрушки
      </div>
      <div class="tablegames-item tablegames-item--dolls">
        куклы и пупсы
      </div>
      <div class="tablegames-item tablegames-item--newborn">
        игрушки для малышей
      </div>
    </div>
  </section>
...
.tablegames {
  background-image: url('~assets/images/background_tablegames.png');
  ...
  @media (max-width: 1023px) {
    background-image: url('~assets/mobile/background_tablegames_mobile.png');
    background-position: center top;
    background-repeat: no-repeat;
    width: 100%;
    max-width: 480px;
  ...
  &-wrapper {
    &--img {
      margin: 62px 0 0 calc(1920px/2 - 870px/2 - 548px);
      display: flex;
      justify-content: center;
      align-items: center;
      @media (max-width: 1920px) {
        margin: 62px 0 0 calc(50vw - 870px/2 - 647px);
      }
      @media (max-width: 1600px) {
        margin: 62px 0 0 calc(50vw - 870px/2 - 487px);
      }
      @media (max-width: 1440px) {
        margin: 62px 0 0 calc(50vw - 870px/2 - 407px);
      }
      @media (max-width: 1280px) {
        margin: 62px 0 0 calc(50vw - 870px/2 - 325px);
      }
      @media (max-width: 1024px) {
        margin: 62px 0 0 calc(50vw - 870px/2 - 199px);
      }
      @media (max-width: 1023px) {
        width: unset;
