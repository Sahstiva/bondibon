<template>
  <section class="teachers">
      <div class="teachers-usefull">
        <svg class="teachers-usefull--arrow"
        ...
        <p class="teachers-usefull--text">полезно педагогам</p>
        <button class="teachers-usefull--button" @click="$emit('goToNextPage', 'BBlinks')">
    ...
    <div class="teachers-items">
      <div class="teachers-items--item teachers-items--speech">речевое развитие</div>
      <div class="teachers-items--item teachers-items--discovery">познавательное развитие</div>
      <div class="teachers-items--item teachers-items--art">художественно- эстетическое развитие</div>
      <div class="teachers-items--item teachers-items--social">социально- коммуника- тивное развитие</div>
      <div class="teachers-items--item teachers-items--catalog">Получите&nbsp;<span class="teachers-items--large">каталог <font-awesome-icon class="teachers-items--mobile" :icon="['fas', 'download']" /></span>
        <span class="teachers-items--nomobile">рекомендованной продукции</span></div>

      <svg class="teachers-items--download"
           xmlns="http://www.w3.org/2000/svg"
           xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <button class="teachers-mobile--download" @click="$emit('goToNextPage', 'BBlinks')">
      <svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M37.3961 25.1602C38.2546 26.0461 38.2546 27.4835 37.3961 28.3694L26.3406 39.7816C25.4821 40.6675 24.0899 40.6675 23.2314 39.7816C22.3727 38.8952 22.3727 37.4583 23.2314 36.5719L34.2867 25.1602C35.1454 24.2738 36.5374 24.2738 37.3961 25.1602Z" fill="#E2BD9E"/>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5923 25.2579C12.4543 24.3677 13.8519 24.3677 14.714 25.2579L25.8132 36.7147C26.6752 37.6044 26.6752 39.0472 25.8132 39.9368C24.9512 40.8265 23.5535 40.8265 22.6916 39.9368L11.5923 28.4801C10.7303 27.5904 10.7303 26.1476 11.5923 25.2579Z" fill="#CA042C"/>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M24.6476 10.3119C25.8745 10.3038 26.8627 11.3107 26.8549 12.5614L26.7546 28.6619C26.7468 29.9126 25.7459 30.9325 24.5191 30.9401C23.2921 30.9483 22.3038 29.9408 22.3116 28.6907L22.412 12.5901C22.4198 11.34 23.4207 10.3195 24.6476 10.3119Z" fill="#E2BD9E"/>
...
.teachers {
  ...
  @media (max-width: 1023px) {
    background-image: url('~assets/mobile/background_teachers_mobile.png');
    background-position: center top;
    background-repeat: no-repeat;
    width: 100%;
    max-width: 480px;
  ...
  &-items {
    ...
    &--discovery {
      background-color: #36b1c2;
    }
    &--art {
      background-color: #32b0a6;
    }
    &--social {
      background-color: #2fa790;
    }
    &--catalog {
